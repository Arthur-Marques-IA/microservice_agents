...
def analyze(
    ...
    file: str | None = typer.Option(
        None, "--file", "-f", help="Arquivo de texto com o documento a analisar. Sem isto: lê de stdin."
    ),
    ...
    ou, com PDF direto: `kuro analyze extrator -a contrato.pdf --json`."""
    st = state(ctx)
    ...
    if file:
        ...
        fail(st, "sem documento: use --file/-f, --attach/-a ou envie por stdin", EXIT_USAGE)
